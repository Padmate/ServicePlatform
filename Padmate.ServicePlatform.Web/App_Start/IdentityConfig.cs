...
namespace Padmate.ServicePlatform.Web
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<ServiceDbContext>()));
            // 配置用户名的验证逻辑
