...
namespace Padmate.ServicePlatform.Models
{
    public class M_IntelInnovationProjectApply:BaseModel
    {
        ...
        /// 领域范围
        /// </summary>
        [OptionalRequired(ErrorMessage = "领域范围不能为空")]
        ...
        /// 项目阶段
        /// </summary>
        [OptionalRequired(ErrorMessage = "项目阶段不能为空")]
        ...
        /// 办公地址
        /// </summary>
        [OptionalRequired(ErrorMessage = "办公地址不能为空")]
        ...
        /// 负责人
        /// </summary>
        [OptionalRequired(ErrorMessage = "负责人名称不能为空")]
        ...
        /// 负责人职位
        /// </summary>
        [OptionalRequired(ErrorMessage = "负责人职位不能为空")]
        ...
        /// 联系人
        /// </summary>
        [OptionalRequired(ErrorMessage = "联系人不能为空")]
        ...
        /// 联系人职位
        /// </summary>
        [OptionalRequired(ErrorMessage = "联系人职位不能为空")]
        ...
        /// 组织概要
        /// </summary>
        [OptionalRequired(ErrorMessage = "概要不能为空")]
        ...
        /// 核心技术
        /// </summary>
        [OptionalRequired(ErrorMessage = "核心技术不能为空")]
        ...
        /// 项目简介/描述
        /// </summary>
        [OptionalRequired(ErrorMessage = "项目简介不能为空")]
        ...
        /// 关键词
        /// </summary>
        [OptionalRequired(ErrorMessage = "关键词不能为空")]
